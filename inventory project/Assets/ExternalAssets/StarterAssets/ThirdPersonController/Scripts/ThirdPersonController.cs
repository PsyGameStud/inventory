...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (_input.inventory && !_isInventoryOpened)
            {
                _input.inventory = false;
                _isInventoryOpened = true;
                _followCamera.gameObject.SetActive(false);
                _inventoryCamera.gameObject.SetActive(true);
                ServiceLocator.Current.Get<WindowManager>().Show<InventoryWindow>(MongrelsTeam.Data.WindowType.Inventory).Forget();
            }
            else if (_input.inventory && _isInventoryOpened)
            {
                _input.inventory = false;
                _isInventoryOpened = false;
                _followCamera.gameObject.SetActive(true);
                _inventoryCamera.gameObject.SetActive(false);
                ServiceLocator.Current.Get<WindowManager>().Hide<InventoryWindow>(MongrelsTeam.Data.WindowType.Inventory).Forget();
            }
